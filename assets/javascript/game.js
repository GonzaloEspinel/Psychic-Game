...
var userGuess = String.fromCharCode(event.keyCode).toLowerCase();
	...
	var html = "<p><h1>My Psychic Game</h1></p>" + "<p><h3>Guess what letter I'm thinking of</h3></p>" + "<p><h3>Wins: " + wins + "</h3></p>" + "<p><h3>Losses: " + losses + "</h3></p>" + "<p><h3>Guesses Left: " + guessesLeft + "</h3></p>" + "<p><h3>Your guesses so far: " + guessesSoFar + "</h3></p>";
